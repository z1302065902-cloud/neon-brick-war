...
interface ImportMetaEnv {
  /** 'free' ships the full campaign; anything else ships the gated demo. */
  readonly VITE_CAMPAIGN?: string;
  /** Live itch.io page, opened by the in-game purchase prompt. */
...
interface Window {
  ...
  __NEON_BRICK__?: import('./game/Game').Game;
}
